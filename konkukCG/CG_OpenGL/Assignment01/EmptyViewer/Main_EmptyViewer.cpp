...
void render()
{
	...
	Surface* S1 = new Sphere(vec3(-4.0, 0.0, -7.0), 1.0);
	Surface* S2 = new Sphere(vec3(0.0, 0.0, -7.0), 2.0);
	Surface* S3 = new Sphere(vec3(4.0, 0.0, -7.0), 1.0);
	Surface* P = new Plane(glm::vec3(0.0, -2.0, 0.0), glm::vec3(0.0, 1.0, 0.0));
	...
	for (int j = 0; j < Height; ++j) 
	{
		for (int i = 0; i < Width; ++i) 
		{
			...
			if (scene.trace(ray, hit_point, normal, hit_surface, t_hit))
			{
