...
3.  [Curves II: Hermite와 Bezier 곡선](#acg_c06_curves_ii_22update)
4.  [Curves III: B-Spline 곡선](#acg_c07_curves_iii)
5.  [Curves IV: 곡선과 쉐이더](#acg_c09_curves_iv)
6.  [Surfaces: 곡면](#acg_c11_surfaces)
7.  [Shader I & II & Review: 쉐이더 기법](#advanced-shaders-review)
8.  [Image Processing: 이미지 처리](#image-processing)
...
## ACG_C06_Curves_II_22update: Hermite와 Bezier 곡선

3차 다항식 곡선은 표현과 제어가 비교적 간단하여 그래픽스에서 널리 사용됩니다. Hermite와 Bezier는 3차 곡선을 정의하는 대표적인 두 방식입니다.
